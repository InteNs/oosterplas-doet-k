    ...
    <div class="col-sm-12 col-md-10">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
                <br>
                <ul>
                    <li><strong>Naam:</strong> {{ $settings->name }}</li> <br>

                    <li><strong>Adres:</strong> {{ $settings->address }}</li> <br>

                    <li><strong>Postcode:</strong> {{ $settings->zipcode }}</li> <br>

                    <li><strong>Emailadres:</strong> {{ $settings->email }}</li> <br>

                    <li><strong>RSIN nummer:</strong> {{ $settings->{'RSIN-number'} }}</li> <br>

                    <li><strong>KvK nummer:</strong> {{ $settings->{'KvK-number'} }}</li> <br>

                    <li><strong>SBI-code:</strong> {{ $settings->{'SBI-code'} }}</li> <br>

                    <li><strong>Rekeningnummer:</strong> {{ $settings->{'account-number'} }}</li> <br>
                </ul>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8">
                {!! Form::open(array('id' => 'contact_form', 'method' => 'POST', 'action' => 'ContactController@store', 'class' => 'well form-horizontal', 'style' => 'height: 500px;')) !!}
                <fieldset>
                    <!-- Form Name -->
                    ...
                    <!-- Success message -->
                        <div class="alert alert-success" role="alert" id="success_message">Success <i
                                    class="glyphicon glyphicon-thumbs-up"></i> Bedankt voor het opnemen van contact met
                            ons, we zullen spoedig een reactie sturen.
                        </div>
                    @endif
