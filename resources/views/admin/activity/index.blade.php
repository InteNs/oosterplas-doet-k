    ...
    <table class="table table-striped table-hover ">
        ...
        @foreach ($activities as $activity)
            <tr>
                ...
                <td>
                    <a href="/beheer/activiteit/{{$activity->id}}" title="View"><i class="fa fa-eye"
                                                                                   aria-hidden="true"></i></a>
                </td>
                <td>
                    <a href="/beheer/activiteit/{{$activity->id}}/edit" title="Edit"><i class="fa fa-pencil"
                                                                                        aria-hidden="true"></i></a>
                </td>
                <td>
                    <a href="javascript:checkDelete({{$activity->id}});" title="Delete"><i class="fa fa-times"
                                                                                           aria-hidden="true"></i></a>
                </td>
            </tr>
        @endforeach
